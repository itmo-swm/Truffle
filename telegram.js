    ...
    qr_image_format = 'png',
    redis = require('./redis_global'),
    Web3 = require('web3'),
    web3 = new Web3(new Web3.providers.HttpProvider(proj_config.rpc_server+':'+proj_config.rpc_port)),
    TheBank = web3.eth.contract(proj_config.address.TheBank,proj_config.ABI.TheBank);
    ...
    var web3 = new Web3(new Web3.providers.HttpProvider(proj_config.rpc_server));
    ...
    bot.on('/dispose', msg => {
      ...
      TheBank.balanceOf.call(account,{from : proj_config.address.TheBank}).then(function(balance){
          ...
          redis.set(rand_for_qr,Date().now());
          ...
          write_stream.on('close',function(){
            // send QR
            return bot.sendPhoto(fromId, qr_image_path , { fileName:qr_image_name });
            // request location
